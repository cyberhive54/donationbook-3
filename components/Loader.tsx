  ...
  return (
    <div className="grid grid-cols-2 md:grid-cols-4 gap-4 mb-6">
      {Array.from({ length: 4 }).map((_, i) => (
        <div key={i} className="bg-gray-100 dark:bg-gray-800 rounded-lg shadow-md p-4 animate-pulse">
...
export function InfoSkeleton() {
  return (
    <div className="bg-gray-100 dark:bg-gray-800 rounded-lg shadow-md p-6 mb-6 animate-pulse">
